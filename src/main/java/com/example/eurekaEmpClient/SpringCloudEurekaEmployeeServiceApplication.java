package com.example.eurekaEmpClient;
...
import com.example.eurekaEmpClient.model.Employee;
import com.example.eurekaEmpClient.repository.EmployeeRepository;
...
@EnableSwagger2
public class SpringCloudEurekaEmployeeServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringCloudEurekaEmployeeServiceApplication.class, args);
	}
	...
	public Docket swaggerApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.example.eurekaEmpClient.controller"))
